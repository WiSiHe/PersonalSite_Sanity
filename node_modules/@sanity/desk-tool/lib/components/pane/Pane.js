...
var _excluded = ["children", "currentMaxWidth", "flex", "minWidth", "maxWidth", "selected"];
...
var Pane = /*#__PURE__*/(0, _react.forwardRef)(function Pane(props, ref) {
  ...
  var flex = (pane === null || pane === void 0 ? void 0 : pane.flex) || flexProp;
  var currentMaxWidth = (pane === null || pane === void 0 ? void 0 : pane.currentMaxWidth) || currentMaxWidthProp;
  ...
  var style = (0, _react.useMemo)(() => layoutCollapsed ? {
    flex: 1
  } : {
    flex,
    minWidth: collapsed ? _constants.PANE_COLLAPSED_WIDTH : minWidth || _constants.PANE_DEFAULT_MIN_WIDTH,
    // eslint-disable-next-line no-nested-ternary
    maxWidth: collapsed ? _constants.PANE_COLLAPSED_WIDTH : // eslint-disable-next-line no-nested-ternary
    maxWidth ? Math.min(currentMaxWidth || maxWidth, maxWidth || currentMaxWidth) : isLast ? undefined : currentMaxWidth
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_components.LegacyLayerProvider, {
    ...
    direction: "column",
    height: "fill"
  }, children))))), !isLast && !layoutCollapsed && /*#__PURE__*/_react.default.createElement(_components.LegacyLayerProvider, {
    zOffset: "paneResizer"
