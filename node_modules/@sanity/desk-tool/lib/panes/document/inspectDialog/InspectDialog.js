...
function InspectDialogComponent(props) {
  ...
  var dialogIdPrevix = "".concat(idPrefix, "_inspect_");
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Dialog, {
    id: "".concat(dialogIdPrevix, "dialog"),
    ...
    "aria-controls": "".concat(dialogIdPrevix, "tabpanel"),
    fontSize: 1,
    id: "".concat(dialogIdPrevix, "tab-").concat(_constants.VIEW_MODE_PARSED.id),
    ...
    "aria-controls": "".concat(dialogIdPrevix, "tabpanel"),
    fontSize: 1,
    id: "".concat(dialogIdPrevix, "tab-").concat(_constants.VIEW_MODE_RAW.id),
    ...
    "aria-labelledby": "".concat(dialogIdPrevix, "tab-").concat(viewMode.id),
    flex: 1,
    id: "".concat(dialogIdPrevix, "tabpanel"),
    overflow: "auto",
    padding: 4,
    style: {
      outline: 'none'
