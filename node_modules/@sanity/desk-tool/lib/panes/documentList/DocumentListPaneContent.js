...
function DocumentListPaneContent(props) {
  ...
  var renderItem = (0, _react.useCallback)(item => /*#__PURE__*/_react.default.createElement(_paneItem.PaneItem, {
    icon: showIcons === false ? false : undefined,
    id: (0, _draftUtils.getPublishedId)(item._id),
    isSelected: childItemId === (0, _draftUtils.getPublishedId)(item._id),
    isActive: isActive,
    layout: layout,
  ...
  var content = (0, _react.useMemo)(() => {
    ...
    }), (isLoading || hasMoreItems) && /*#__PURE__*/_react.default.createElement(_ui.Box, {
      marginTop: 1,
      padding: 4
    }, /*#__PURE__*/_react.default.createElement(_ui.Text, {
      align: "center",
      muted: true
    }, isLoading && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "Loading\u2026"), !isLoading && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "The list has more documents"))));
