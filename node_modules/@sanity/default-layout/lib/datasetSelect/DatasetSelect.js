...
function DatasetSelect(props) {
  ...
  var currentSpaceSubscription = (0, _react.useRef)();
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.Select, _extends({
    onChange: handleChange,
    value: currentSpace && currentSpace.name || undefined,
    radius: 2
  }, props), _spaces.CONFIGURED_SPACES.map(space => /*#__PURE__*/_react.default.createElement("option", {
    key: space.name,
    value: space.name
  }, space.title)));
}