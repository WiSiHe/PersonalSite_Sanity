...
function Navbar(props) {
  ...
  var _useState5 = (0, _react.useState)(null),
      ...
      searchButtonElement = _useState6[0],
      setSearchButtonElement = _useState6[1];
  ...
  var rootState = (0, _react.useMemo)(() => {
    var _router$state, _router$state2;

    return _spaces.HAS_SPACES && router !== null && router !== void 0 && (_router$state = router.state) !== null && _router$state !== void 0 && _router$state.space ? {
      space: router === null || router === void 0 ? void 0 : (_router$state2 = router.state) === null || _router$state2 === void 0 ? void 0 : _router$state2.space
    } : {};
  }, [router]);
  var shouldRender = {
  ...
  (0, _ui.useGlobalKeyDown)(e => {
    if (e.key === 'Escape' && searchOpen) {
      setSearchOpen(false);
      searchButtonElement === null || searchButtonElement === void 0 ? void 0 : searchButtonElement.focus();
    }
  });
